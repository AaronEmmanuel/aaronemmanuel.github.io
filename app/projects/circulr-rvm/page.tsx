...
export default function CirculrPage() {
  return (
    <main className="case circulr-case">
      ...
      <section className="circulr-deployment shell"><div><p className="eyebrow">04 / In the real world</p><h2>From the workshop<br />to Fiesta Farms.</h2><p>The mini RVM entered operation at Fiesta Farms in Toronto in October 2025. A later update from Circulr reported five months of error-free operation.</p><p className="circulr-source-note">Operational update reported by Circulr; not an independently measured uptime statistic.</p></div><div className="circulr-timeline"><div><span>June 2024 – August 2025</span><strong>Full-time technical lead</strong><p>Design, integration, build, software development, and testing.</p></div><div><span>October 2025</span><strong>Retail deployment</strong><p>Single-module RVM installed at Fiesta Farms.</p></div><div><span>Through June 2026</span><strong>Continued development and support</strong><p>Part-time work as an independent contractor following the full-time role.</p></div></div></section>
