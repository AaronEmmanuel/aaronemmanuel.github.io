...
export default function ProjectsPage() {
  return (
    <main>
      <section className="page-hero shell projects-hero"><p className="eyebrow">Project library</p><h1>Systems designed, built, and tested.</h1><div className="page-intro"><p>A growing archive of industry, university, graduate, and independent engineering work.</p><p>Each case study follows the project from early decisions through design, integration, and demonstrated results.</p></div></section>
      <section className="library shell">
        ...
        <ProjectCard number="04" title="Circulr Reverse Vending Machine" summary="Sole technical ownership of a reusable-container return machine, from mechanical design and embedded software to fabrication, testing, and deployment at Fiesta Farms in Toronto." tags={["Industry project", "Circulr", "2024–2026"]} href="/projects/circulr-rvm" media="/circulr/return-demo.mp4" poster="/circulr/fiesta-farms.jpg" still />
      </section>
